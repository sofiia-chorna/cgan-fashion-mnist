...
class Discriminator(nn.Module):
    def __init__(self, params):
        ...
        self.maxout_img = Maxout(d_in=self.img_dim * self.img_dim, num_piece=5, num_units=240)
        self.maxout_label = Maxout(d_in=self.n_classes, num_piece=5, num_units=50)
        ...
        self.dropout = nn.Dropout(self.droupout)
